...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.m')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/MxA_Bots'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://te.legra.ph/file/42e9a66c3df08a9c1987a.mp4'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🙄 ᴏᴡɴᴇʀ 🙄', url='https://t.me/Movies_X_Animes'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/MxA_Bots'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://te.legra.ph/file/42e9a66c3df08a9c1987a.mp4'), #Please Change your bot username
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me/movies_X_animes/44')
        ]
    )
    if offset != "":
